...
Software Engineer building production iOS apps with **SwiftUI** and full-stack web platforms with **ASP.NET Core**, **React**, **Node.js**, and **Azure**. Focused on clean architecture, performance, and shipping software that works in the real world.

Currently working at **BigBlue Technologies** as a Developer Intern, building iOS features and full-stack solutions.

**Open to:** iOS Engineer and Software Engineer / Full-Stack opportunities
